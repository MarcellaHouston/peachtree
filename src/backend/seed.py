...
db.insert("users", [
    ...
    json.dumps({"monday": 5, "tuesday": 5, "wednesday": 5, "thursday": 5, "friday": 5, "saturday": 5, "sunday": 5}),
])
...
db.insert("goals", [
    ...
    "Reach Staff", "2026-01-01",
    "medium", "Operations", None,
])
...
db.insert("tasks", [
    ...
    2, 2, None,       # twice a week — enough to stay in sync without overdoing it
    "2026-01-01", "2026-12-31",
    4,
])
db.insert("tasks", [
    ...
    1, 3, None,       # once a week — a recurring scheduled meeting
    "2026-01-01", "2026-12-31",
    3,
])
db.insert("tasks", [
    ...
    5, 1, None,       # daily Mon–Fri — keeping communication flowing every workday
    "2026-01-01", "2026-12-31",
    5,
])
...
db.insert("tasks", [
    ...
    5, 2, None,       # daily Mon–Fri — pipeline hygiene needs consistent attention
    "2026-01-01", "2026-12-31",
    5,
])
db.insert("tasks", [
    ...
    3, 1, None,       # 3x a week — steady outreach without burning out the list
    "2026-01-01", "2026-12-31",
    4,
])
db.insert("tasks", [
    ...
    5, 1, None,       # daily — keeping the record clean every day
    "2026-01-01", "2026-12-31",
    3,
])
...
db.insert("tasks", [
    ...
    3, 1, None,       # 3x a week — enough coverage to spot patterns quickly
    "2026-03-01", "2026-09-30",
    3,
])
db.insert("tasks", [
    ...
    2, 2, None,       # twice a week — incremental improvements add up fast
    "2026-03-01", "2026-09-30",
    2,
])
db.insert("tasks", [
    ...
    3, 2, None,       # 3x a week — direct feedback loop with real users
    "2026-03-01", "2026-09-30",
    4,
])
...
db.insert("tasks", [
    ...
    4, 1, None,       # 4x a week — staying on top of incoming feedback
    "2026-01-01", "2026-12-31",
    3,
])
db.insert("tasks", [
    ...
    2, 1, None,       # twice a week — keeps the feedback loop active
    "2026-01-01", "2026-12-31",
    2,
])
db.insert("tasks", [
    ...
    2, 2, None,       # twice a week — turning detractors around takes persistence
    "2026-01-01", "2026-12-31",
    4,
])
